...
public class NoCollisionRectangleHandlerTest extends RectangleHandlerTest {

    public NoCollisionRectangleHandlerTest() {
        rectangleHandler = new NoCollisionRectangleHandler();
    }
